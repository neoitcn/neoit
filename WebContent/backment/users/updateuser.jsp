	...
	<div id="pageAll"  >
		...
		<div >
			...
			<div style="text-align:center; ">
			 ...
			 <span style="color: red;font-size:25px;">您的权限不足,无法修改用户!</span>  	 
			 </c:if>
		  ...
		  <c:if test="${loginUser.name=='admin' }">
			...
			<div class="banneradd bor" style="text-align:center;" > 
				...
				<form action="user/UpdateUser.do" name="form2"  method="post">
				    <div class="bbD">
					真实姓名：<span style="color: red;">*</span>
					<input type="text" name="realName"  value="${user.realName }" class="input3" />
					</div>
					<div class="bbD">&nbsp;&nbsp;
					用户名：<span style="color: red;">*</span>
						<input type="text"  value="${user.name }" name="name" class="input3" />
					</div>
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码：
					...
					<div class="bbD">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注：
						<input type="text" value="${user.remarks }"
						name="remarks"	class="input3" />
					</div>
					 <div class="bbD">
						<!-- 更新者ID(默认登陆用户id) 和被更新用户id,隐藏提交 -->
					...
					<div class="bbD">
						<p class="bbDP">
							<button type="button" onclick="checkformdata()" style="margin-left: 100px;"  class="btn_ok btn_yes" >修改</button> 
